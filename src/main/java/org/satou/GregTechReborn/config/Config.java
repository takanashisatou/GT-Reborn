package org.satou.GregTechReborn.config;
...
import org.satou.GregTechReborn.GregTechReborn;
...
@EventBusSubscriber(modid = GregTechReborn.MODID, bus = EventBusSubscriber.Bus.MOD)
public class Config {
